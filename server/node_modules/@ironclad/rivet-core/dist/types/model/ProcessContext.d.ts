...
import { type Settings, type NativeApi, type Project, type DataValue, type ExternalFunction, type Outputs, type GraphId, type GraphProcessor, type ScalarOrArrayDataValue, type DatasetProvider, type ChartNode, type AttachedNodeData } from '../index.js';
...
export type InternalProcessContext<T extends ChartNode = ChartNode> = ProcessContext & {
    ...
    createSubProcessor: (subGraphId: GraphId, options?: {
        signal?: AbortSignal;
    }) => GraphProcessor;
