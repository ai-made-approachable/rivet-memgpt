...
import { type GraphId, type GraphProcessor, type Project, type Settings, type GraphInputs, type NodeId } from '@ironclad/rivet-core';
...
export declare const currentDebuggerState: {
    ...
    settings: Settings<Record<string, Record<string, unknown>>> | undefined;
};
